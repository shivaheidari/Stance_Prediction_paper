...
# user_list = open(users_1st_batch, "r").readlines()
...
test_size = 0.2
users_1st_batch = "Data/Galaxy_ds/sample_users/sample10.csv"
f = open("Report/reslstm_batch1.txt", "w")
...
for user in file.readlines():
    ...
    for epoch in range(num_epochs):
        ...
        precision_scores.append(precision_score(labels, predicted, average='weighted'))
        recall_scores.append(recall_score(labels, predicted, average='weighted'))
    ...
    f.write("\n")
    #save the model
    # user_model = "Data/Galaxy_ds/User_Models/lstm_" + user + ".pth"
    # torch.save(model.state_dict(), user_model)
